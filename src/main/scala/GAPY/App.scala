...
object App {
  ...
  def main(args : Array[String]) {
    ...
    p
    .addTopology(new StarNetwork(LocalHub("LocalHub1"),List(LocalVpcs("PC0-0"),LocalVpcs("PC0-1"),LocalVpcs("PC0-2"),LocalVpcs("PC0-3"),LocalVpcs("PC0-4"),LocalVpcs("PC0-5"),LocalVpcs("PC0-6"))))
    ...
    .addTopology(new StarLinearNetwork(LocalHub("LocalHub3"),List(LocalHub("PC2-0"),LocalHub("PC2-1"),LocalHub("PC2-2"),LocalHub("PC2-3"),LocalHub("PC2-4"),LocalHub("PC2-5"),LocalHub("PC2-6"))))
    .addLink(SimpleLink(LocalHub("LocalHub1"),LocalHub("LocalHub2"),7,6))
    .addLink(SimpleLink(LocalHub("LocalHub2"),LocalHub("LocalHub3"),7,7))
